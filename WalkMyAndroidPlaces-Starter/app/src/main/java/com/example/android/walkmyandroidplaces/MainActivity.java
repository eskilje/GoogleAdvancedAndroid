...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == REQUEST_PICK_PLACE) {
            if(resultCode == RESULT_OK) {
                ...
                mLocationTextView.setText(getString(R.string.address_text, place.getName(), place.getAddress(), new Date()));
            }
            else {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pickAPlaceButton = (Button) findViewById(R.id.pick_a_place);
                                ...
                                if (currentPlace != null) {
                                    mLocationTextView.setText(
                                            getString(R.string.address_text,
                                                    ...
                                                    result, //This is the address from the AsyncTask,
